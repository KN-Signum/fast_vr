...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR RuntimeObject* Dictionary_2_System_Collections_IDictionary_get_Item_m85D84CC2113147BD64E823AA165E5631E3C46E71_gshared (Dictionary_2_tBB0304460869B81DAF44C0A8E20BF773FABB416D* __this, RuntimeObject* ___0_key, const RuntimeMethod* method) 
{
	int32_t V_0 = 0;
	{
		...
		bool L_1;
		L_1 = Dictionary_2_IsCompatibleKey_m976A60AB3FE078A2E306F09833F5CF45FE4DBEE2(L_0, il2cpp_rgctx_method(method->klass->rgctx_data, 57));
		if (!L_1)
		{
			goto IL_0030;
		}
	}
	{
		...
		int32_t L_3;
		L_3 = Dictionary_2_FindEntry_mAFCAFB53ECC2F020C9CCE4EC31F35C483E1A62F6(__this, ((*(XrPassthroughHTC_t357B7E5FF3A9FC5C40634A6FF4E64B6DE5F62F3D*)UnBox(L_2, il2cpp_rgctx_data(method->klass->rgctx_data, 14)))), il2cpp_rgctx_method(method->klass->rgctx_data, 30));
		V_0 = L_3;
		int32_t L_4 = V_0;
		if ((((int32_t)L_4) < ((int32_t)0)))
		{
...
IL_0009:
	...
	try
	{
		...
		try
		{
			...
			Dictionary_2_set_Item_mC6DAE9CF6DFBB122402CF01E1A500394581282C6(__this, L_3, ((RuntimeObject*)Castclass((RuntimeObject*)L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 15))), il2cpp_rgctx_method(method->klass->rgctx_data, 60));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
