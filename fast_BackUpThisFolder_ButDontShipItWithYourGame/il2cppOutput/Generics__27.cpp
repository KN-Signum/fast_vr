...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR RuntimeObject* Dictionary_2_System_Collections_IDictionary_get_Item_mEC73579EBFB4825371E9B69BD0EE70CC356AB769_gshared (Dictionary_2_t6ECD2A800A887666C2F81BDC9FF870530AD2C8DD* __this, RuntimeObject* ___0_key, const RuntimeMethod* method) 
{
	int32_t V_0 = 0;
	{
		RuntimeObject* L_0 = ___0_key;
		bool L_1;
		L_1 = Dictionary_2_IsCompatibleKey_m26FEEB699290DE3679EA255A28847CDE011D932B(L_0, il2cpp_rgctx_method(method->klass->rgctx_data, 57));
		if (!L_1)
		{
			goto IL_0030;
		}
	}
	{
		RuntimeObject* L_2 = ___0_key;
		int32_t L_3;
		L_3 = Dictionary_2_FindEntry_mE400CE06159B032E8A0941047CD5B6D901F306AC(__this, ((*(int32_t*)UnBox(L_2, il2cpp_rgctx_data(method->klass->rgctx_data, 14)))), il2cpp_rgctx_method(method->klass->rgctx_data, 30));
		V_0 = L_3;
		int32_t L_4 = V_0;
		if ((((int32_t)L_4) < ((int32_t)0)))
		{
...
IL_0009:
	{
		RuntimeObject* L_1 = ___1_value;
		ThrowHelper_IfNullAndNullsAreIllegalThenThrow_TisFingerPinchThreshold_t1CC1ED7B73E2DB07439966277EEFDB5CDDC43386_m095615B0833DA7AF997AAC5714256CB3ED95E2B6(L_1, (int32_t)((int32_t)15), il2cpp_rgctx_method(method->klass->rgctx_data, 59));
	}
	try
	{
		{
		...
		try
		{
			int32_t L_3 = V_0;
			RuntimeObject* L_4 = ___1_value;
			Dictionary_2_set_Item_m06D02F911AA2108A32C4763F0F8DF7AF532DD318(__this, L_3, ((*(FingerPinchThreshold_t1CC1ED7B73E2DB07439966277EEFDB5CDDC43386*)UnBox(L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 15)))), il2cpp_rgctx_method(method->klass->rgctx_data, 60));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
